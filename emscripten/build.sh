...
# Using bundled libomp.a because the system OpenMP library is missing in CI environment
...
# Linker Flags
# Link against the bundled static libomp.a directly since system -lomp is unavailable in CI
...
# Use the bundled libomp.a for OpenMP support
USER_LIBOMP=""
if [ -f "$SCRIPT_DIR/libomp.a" ]; then
    echo "Found bundled libomp.a, linking it..."
