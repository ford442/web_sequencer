...
describe('SamplerPanel Memoization', () => {
    ...
    it('re-renders children when active bank params change', () => {
        ...
        // Initial render: 16 knobs (4 basic + 9 engine + 5 pitch controls + 3 adsr) = 21 -> Now 23 (Added Decay and Sustain) -> Now 25 (Added Tremolo Depth and Rate)
        expect(Knob).toHaveBeenCalledTimes(25);
        vi.clearAllMocks();
