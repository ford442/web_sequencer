...
export const AutomationLaneList = memo(({ selectedLaneId, onSelectLane }: AutomationLaneListProps) => {
  ...
  if (state.lanes.length === 0) {
    return (
      <div role="status" className="flex flex-col items-center justify-center py-12 px-4 text-center bg-[#1a1d24]/50 border border-dashed border-gray-700 rounded-lg m-2">
