            ...
            <div className="flex items-center gap-2">
                ...
                {viewMode === 'automation' && (
                    <select
                        ...
                        className="bg-zinc-950 text-[10px] text-gray-300 border border-zinc-800 rounded px-1.5 py-1 outline-none focus:border-cyan-500 focus-visible:ring-2 focus-visible:ring-offset-1 focus-visible:ring-offset-zinc-950"
                    >
