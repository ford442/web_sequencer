                    ...
                    {activeTab === 'browse' ? (
                        <div className="space-y-4">
                            ...
                            {isLoading ? (
                                ...
                                <div role="status" aria-live="polite" className="flex flex-col items-center justify-center py-12 text-center bg-gray-800/20 border border-dashed border-gray-700 rounded-lg">
