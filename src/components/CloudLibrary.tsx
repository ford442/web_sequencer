                    ...
                    {activeTab === 'browse' ? (
                        <div className="space-y-4">
                            ...
                            {isLoading ? (
                                ...
                                <div role="status" aria-live="polite" role="status" aria-live="polite" className="flex flex-col items-center justify-center py-12 text-center bg-gray-800/20 border border-dashed border-gray-700 rounded-lg">
                                    ...
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 transition-transform group-hover:-translate-y-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
