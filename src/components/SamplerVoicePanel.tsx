...
export const SamplerVoicePanel: React.FC<SamplerVoicePanelProps> = React.memo(({
    ...
    return (
        <div className="relative w-full h-full flex flex-col">
            ...
            <div className="h-[280px] bg-gradient-to-b from-zinc-900 via-zinc-950 to-black border-t-2 border-purple-500/30 p-3 flex gap-4 shrink-0 relative overflow-y-auto overflow-x-hidden">
                {/* Subtle grid pattern */}
