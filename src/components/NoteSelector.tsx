                            ...
                            <div className="flex gap-2 justify-between">
                                <div className="flex flex-col items-center gap-1">
                                    ...
                                    <input
                                        ...
                                        value={currentNote?.pitchAmount ?? 0}
                                    ...
                                    <span className="text-[10px] text-gray-300 font-mono">
                                        {(currentNote?.pitchAmount ?? 0) > 0 ? '+' : ''}{(currentNote?.pitchAmount ?? 0).toFixed(1)}st
                                    </span>
                                </div>
                                <div className="flex flex-col items-center gap-1">
                                    ...
                                    <input
                                        ...
                                        value={currentNote?.pitchAttack ?? 0}
                                ...
                                <div className="flex flex-col items-center gap-1">
                                    ...
                                    <input
                                        type="range"
                                        min="0" max="1" step="0.01"
                                        value={currentNote?.pitchDecay ?? 0}
