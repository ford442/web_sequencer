          ...
          {tab === 'search' && (
            <div role="tabpanel" className="space-y-4">
              ...
              <ul className="space-y-2" role="list">
                ...
                {results.length === 0 && (
                  <li role="status" aria-live="polite" role="status" aria-live="polite" className="flex flex-col items-center justify-center py-12 px-4 text-center bg-gray-800/20 border border-dashed border-gray-700 rounded-lg mt-4">
