      ...
      {notes.map((note) => {
        ...
        return (
          <button type="button"
            ...
            className={`text-[10px] font-mono py-0.5 px-2 rounded transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-400 focus-visible:ring-opacity-50 ${
              isSelected
        ...
        <div className="col-span-3 flex flex-col gap-2" role="group" aria-label="RubberBand Engine Settings">
          ...
          <div className="flex flex-col gap-1">
            ...
            <select
              ...
              className="bg-gray-800 border border-gray-700 text-white text-[10px] rounded px-2 py-1 outline-none focus-visible:border-purple-500 focus-visible:ring-2 focus-visible:ring-purple-500"
            >
