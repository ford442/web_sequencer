...
const VerticalMiniLadder: React.FC<VerticalMiniLadderProps> = React.memo(
  ({ selected, onSelect }) => {
...
export const SamplerPitchControls: React.FC<SamplerPitchControlsProps> =
  React.memo(({ bankId, values, onChange }) => {
    ...
    return (
      ...
      >
        ...
        <div className="grid grid-cols-12 gap-3">
          ...
          {/* Pitch Knobs Row */}
          <div
            className="col-span-7 grid grid-cols-4 gap-2"
            role="group"
            aria-label="Pitch Adjustment Controls"
          >
          ...
          <div
            ...
            role="group"
            aria-label="RubberBand Engine Settings"
          >
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor={qualityId} className="text-[9px] text-gray-500">
                Quality
              </label>
              <select
                id={qualityId}
                ...
                onChange={(e) =>
                  onChange(
                    "quality",
                    e.target.value as "preview" | "good" | "better" | "best",
                  )
                }
            ...
            {/* Stretch Mode Select */}
            <div className="flex flex-col gap-1">
              <label htmlFor={modeId} className="text-[9px] text-gray-500">
                Mode
              </label>
              <select
                id={modeId}
                ...
                onChange={(e) =>
                  onChange(
                    "stretchMode",
                    e.target.value as "Time" | "Pitch" | "Formant",
                  )
                }
                className="bg-gray-800 border border-gray-700 text-white text-[10px] rounded px-2 py-1 outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500"
              >
            ...
            >
              ...
              <span
                id={`${lockToSequencerId}-label`}
                className="text-[10px] text-gray-300 hover:text-white transition-colors leading-none select-none"
              >
                Lock to Seq
              </span>
            </div>
