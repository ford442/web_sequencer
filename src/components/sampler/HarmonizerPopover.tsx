...
export const HarmonizerPopover: React.FC<HarmonizerPopoverProps> = React.memo(
  ({ isOpen, onClose, config, isActive, onApply, colorHex }) => {
    ...
    const handleDetuneChange = (value: number) => {
      setLocalConfig((prev) => ({
        ...prev,
        detuneSpread: Math.round(value * 50),
      }));
    };
    ...
    const handleFormantChange = (value: number) => {
      setLocalConfig((prev) => ({
        ...prev,
        formantSpread: Math.round(value * 12),
      }));
    };
    ...
    return (
      <>
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(145deg, rgba(15,23,42,0.98), rgba(5,7,9,0.99))",
        ...
        >
          ...
          >
            ...
            />
            <span
              className="text-xs font-bold font-orbitron tracking-wider relative z-10 flex items-center gap-1.5"
            ...
            <button
              ...
              aria-label={
                localActive ? "Disable Harmonizer" : "Enable Harmonizer"
              }
            ...
            >
              <span className="flex items-center gap-1.5">
                {localActive && (
                  <span className="w-1 h-1 rounded-full bg-green-400 shadow-[0_0_4px_rgba(74,222,128,0.8)]" />
                )}
                {localActive ? "ON" : "OFF"}
              </span>
            </button>
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div
                role="radiogroup"
                aria-labelledby="voice-count-label"
                className="flex gap-2 bg-zinc-950/50 p-1 rounded-lg border border-zinc-800"
              >
                {[2, 3, 4].map((count) => (
                  <button
                    type="button"
            ...
            <div className="space-y-2">
              ...
              <div
                role="radiogroup"
                aria-labelledby="harmony-type-label"
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <span
                  className="text-[9px] font-mono font-bold px-1.5 py-0.5 rounded bg-zinc-950 border border-zinc-800"
            ...
            <div className="space-y-2">
              ...
              <div className="relative h-5 bg-zinc-900 rounded-md border border-zinc-700 overflow-hidden shadow-[inset_0_2px_4px_rgba(0,0,0,0.5)]">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleBusGainChange(parseInt(e.target.value) / 100)
                  }
                  className="absolute inset-0 w-full h-full opacity-0 cursor-pointer"
            ...
            <div className="space-y-2">
              ...
              <div className="relative h-5 bg-zinc-900 rounded-md border border-zinc-700 overflow-hidden shadow-[inset_0_2px_4px_rgba(0,0,0,0.5)]">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleBusCompressorThresholdChange(parseInt(e.target.value))
                  }
                  className="absolute inset-0 w-full h-full opacity-0 cursor-pointer"
            ...
            <div className="space-y-2">
              ...
              <div className="relative h-5 bg-zinc-900 rounded-md border border-zinc-700 overflow-hidden shadow-[inset_0_2px_4px_rgba(0,0,0,0.5)]">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleBusEqGainChange(parseFloat(e.target.value))
                  }
                  className="absolute inset-0 w-full h-full opacity-0 cursor-pointer"
            ...
            <div className="space-y-2">
              ...
              <div className="relative h-5 bg-zinc-900 rounded-md border border-zinc-700 overflow-hidden shadow-[inset_0_2px_4px_rgba(0,0,0,0.5)]">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleBusWidenerChange(parseInt(e.target.value) / 100)
                  }
                  className="absolute inset-0 w-full h-full opacity-0 cursor-pointer"
                ...
                {[
                  ...
                  <button
                    ...
                    onClick={() =>
                      setLocalConfig(
                        HARMONIZE_PRESETS[
                          key as keyof typeof HARMONIZE_PRESETS
                        ](),
                      )
                    }
