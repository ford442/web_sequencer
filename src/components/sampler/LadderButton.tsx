...
export const LadderButton: React.FC<LadderButtonProps> = React.memo(({ note, isActive, onClick, buttonRef }) => (
    <button type="button"
        ...
        className={`w-8 h-5 text-[9px] font-mono font-bold rounded transition-all relative overflow-hidden focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 focus-visible:ring-opacity-50 ${
            isActive
