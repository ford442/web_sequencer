...
export const AutomationVisualizationPanel: React.FC<AutomationVisualizationPanelProps> = React.memo(({
  ...
  if (trackStats.automationLaneCount <= 0 || !parsedData?.automation) {
    return (
      <div className="p-4">
        <div role="status" className="flex flex-col items-center justify-center py-8 px-4 text-center bg-gray-800/20 border border-dashed border-gray-700 rounded-lg">
