...
export const TrackStatisticsPanel: React.FC<TrackStatisticsPanelProps> = React.memo(({ trackStats, trackStatisticsRows }) => {
  if (!trackStats) {
    return (
      <div className="p-4">
        <div role="status" aria-live="polite" className="flex flex-col items-center justify-center py-8 px-4 text-center bg-gray-800/20 border border-dashed border-gray-700 rounded-lg">
