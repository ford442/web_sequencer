        ...
        return (
            <div className={`flex flex-col gap-1.5 w-full ${className}`}>
                ...
                <div className="relative">
                    ...
                    <div
                        {...interactionProps}
                        className={`h-5 bg-zinc-900 rounded-md border cursor-ew-resize relative overflow-hidden shadow-[inset_0_2px_4px_rgba(0,0,0,0.5),inset_0_-1px_0_rgba(255,255,255,0.03)] focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-400 ${
                            isAutomated
        ...
        return (
            <div className={`flex flex-col items-center gap-1 ${className}`}>
                ...
                <div className="relative">
                    ...
                    <div
                        {...interactionProps}
                        className={`w-6 rounded-full bg-zinc-900 cursor-ns-resize relative overflow-hidden focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-400 ${
                            isAutomated
