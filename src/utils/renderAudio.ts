...
import { getTunedFrequency, type TuningSystem } from './musicTheory';
...
export async function renderSynthToBuffer(
    ...
    const time = 0;
    const baseFreq = getTunedFrequency(note, '12-TET' as TuningSystem, 'C'); // default for offline rendering
