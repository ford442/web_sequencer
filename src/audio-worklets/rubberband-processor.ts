...
// Polyfill performance.now() for AudioWorklet environments where it might be missing (e.g. Safari, or specific configurations)
// This is required because the Emscripten-generated code in rubberband-lib.js relies on performance.now()
