...
class RubberBandProcessor extends AudioWorkletProcessor {
  ...
  static get parameterDescriptors() {
    return [
      ...
      { name: 'grainPitchEnvDepth', defaultValue: 0.0, minValue: -24.0, maxValue: 24.0 },
  ...
  process(_inputs: Float32Array[][], outputs: Float32Array[][], parameters: Record<string, Float32Array>): boolean {
    ...
    // Granular Pitch Shift & Granular Pitch Envelope
    ...
    let totalGranularShift = granularPitchShift;

    if (grainPitchEnvDepth !== 0.0) {
        totalGranularShift += grainPitchEnvDepth * pitchEnvelopeValue;
    }

    if (totalGranularShift !== 0.0) {
      const pitchShiftRatio = Math.pow(2.0, totalGranularShift / 12.0);
